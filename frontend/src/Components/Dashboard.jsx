...
export const Dashboard = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      await Axios.get("http://localhost:9000/api/fivetransaction/" + state.user)
        .then((res) => res.data)
  ...
  return (
    <div>
      <div className="container text-center mt-3">
        ...
        <div className="row">
          <div
            className="col-lg-4 shadow-sm p-3 mb-5 mx-1  rounded"
          ...
          <div
            className="col-lg-3 shadow-sm p-3 mb-5 mx-1 rounded"
            style={{ backgroundColor: "#fffcc8" }}
          >
            <h5>Balance</h5>
            <div>₹900</div>
